...
int main(int argc, char *argv[])
{
	...
	if (maze->t == 0) {
		...
		if (ver == 1) {
			printf("Problem z odczytem labiryntu z danego pliku. %s\n", mazeFileName);
			printf("Po instrukcje uzyj:\n%s -h\n", argv[0]);
			printf("Sprawdz poprawnosc pliku i sekcje Plik Wejsciowy w dokumentacji.");
			return 1;
		}
		...
		if (bin == -1) {
			...
			printf("W pliku znajduje sie juz rozwiazanie. Nie nadpisano pliku.\n");
			printf("Po instrukcje uzyj:\n%s -h\n", argv[0]);
			printf("Sprawdz poprawnosc pliku i sekcje Plik Wejsciowy w dokumentacji.");
			return 1;
		}
